...
export type Database = {
  public: {
    Tables: {
      ...
      knowledge_articles: {
        Row: {
          ...
          created_by: string;
          title: string;
          category: "wiki" | "company" | "policies" | "guides" | "playbooks";
          summary: string | null;
          body: string;
          tags: string[];
      ...
      document_settings: {
        Row: {
          workspace_id: string;
          default_share_permission: "view" | "comment" | "edit" | "owner";
      ...
      analytics_widgets: {
        Row: {
          ...
          title: string;
          metric_key: string;
          widget_type: "metric" | "line" | "bar" | "area" | "pie" | "heatmap" | "table";
          position: number;
          config: Json;
          created_at: string;
          updated_at: string;
    ...
    Enums: {
      ...
      calendar_event_status: "scheduled" | "confirmed" | "completed" | "cancelled";
      calendar_event_priority: "low" | "medium" | "high" | "urgent";
      calendar_integration_provider: "google" | "outlook" | "apple";
      analytics_widget_type: "metric" | "line" | "bar" | "area" | "pie" | "heatmap" | "table";
      project_status: "planning" | "active" | "on_hold" | "completed" | "archived";
      project_priority: "low" | "medium" | "high" | "urgent";
      project_task_status: "backlog" | "todo" | "in_progress" | "review" | "completed";
      document_status: "draft" | "published" | "archived" | "trashed";
      document_share_permission: "view" | "comment" | "edit" | "owner";
