...
function PricingHeader() { return <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8"><Link href="/" className="flex items-center gap-2.5"><span className="flex h-8 w-8 items-center justify-center rounded-xl bg-primary text-xs font-bold text-white shadow-soft">B</span><span className="text-sm font-semibold tracking-tight">Business OS</span></Link><div className="flex items-center gap-2"><Link href="/signin"><Button size="sm" variant="ghost">Sign in</Button></Link><Link href="/signup"><Button size="sm">Get started</Button></Link></div></header>; }
...
function SalesCta() { return <section id="contact-sales" className="mt-24 overflow-hidden rounded-3xl border border-primary/30 bg-primary/10 p-8 text-center sm:p-14"><p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">Ready when you are</p><h2 className="mx-auto mt-3 max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl">Give your business one intelligent home.</h2><p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-secondary">Start free today, or talk with us about a secure workspace built around your team.</p><div className="mt-7 flex flex-wrap justify-center gap-3"><Link href="/signup"><Button size="lg" className="gap-2">Start free <ArrowRight className="h-4 w-4" aria-hidden /></Button></Link><a href="mailto:sales@business-os.example"><Button size="lg" variant="secondary">Contact sales</Button></a></div></section>; }
