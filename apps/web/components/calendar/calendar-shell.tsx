...
function Meetings({ events }: { events: InboxCalendarEvent[] }) { return <SectionShell title="Meetings" description="Upcoming, completed, cancelled, and reschedule-ready events from Inbox."><EventList events={events} /></SectionShell>; }
